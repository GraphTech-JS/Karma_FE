...
const AboutSection = () => {
  return (
    <section className="relative bg-white">
      ...
      <div className="w-[1237px] mx-auto px-5 relative z-[2]">
        <div className="flex items-center gap-5">
          ...
          <div className="flex flex-1 flex-col w-full">
            <h2 className="font-family-unbounded text-[40px] font-semibold text-[#020303] mb-6 leading-[1.2]">
              <span className="text-[#ba0108]">П</span>РО НАС
            </h2>
